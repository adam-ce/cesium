...
function main() {
  ...
  var imageryProvider = new UrlTemplateImageryProvider({
    ...
    rectangle: Rectangle.fromDegrees(9.5, 46.25, 17.25, 49.25),
  });
  var terrainProvider = new CesiumTerrainProvider({
    // url: "http://localhost/tiles/v_tinterrain/"
    // url: "http://localhost/tiles/ctb_test/"
    url: "http://gataki.cg.tuwien.ac.at/atb_terrain/",
  });
  ...
  try {
    ...
    // viewModel.terrainProviderViewModels = [terrainProvider];
  ...
  if (!defined(view))
    view =
      "9.857642494344423,44.93667021702355,222525.26883914194,32.49998202882585,-35.17724751021227,359.9987156326992";
